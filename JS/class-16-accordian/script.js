...
const expandAccordianElem = document.querySelector(".accordian-dropdown");

expandAccordianElem.addEventListener("click", () => {
  if (document.querySelector(".accordian-body").style.display === "none") {
    document.querySelector(".accordian-body").style.display = "block";
    expandAccordianElem.classList.remove("fa-caret-down");
    expandAccordianElem.classList.add("fa-caret-up");
  } else {
    document.querySelector(".accordian-body").style.display = "none";
    expandAccordianElem.classList.remove("fa-caret-up");
    expandAccordianElem.classList.add("fa-caret-down");
  }
});
